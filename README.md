...
- [ ] Describe Middleware?
  ...
  - Basically a function(s) that can intercept your request and do stuff with it before potentially passing it on

* [ ] Describe a Resource?

  - Any bit of data an API provides for retrieving or manipulation
...
* [ ] How can we partition our application into sub-applications?
  ...
  - use express.Router() to make namespaces
